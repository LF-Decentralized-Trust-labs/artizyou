...
class Completed extends PureComponent {
  ...
  // handleToConfirmationMessage = () => {
  //   const {user} = this.props;
  //   console.log(this.props);
  //   if(user) {
  //   const {allowRegisterWithoutPayment} = user;
  //   if (allowRegisterWithoutPayment){
  //     return 'creations.new.registration.creation_completed_with_promo';
  //   }
  //   else {
  //     return 'creations.new.registration.creation_completed';
  //   }
  //   }
  //   return 'creations.new.registration.creation_completed';
  // };
    ...
    return (
      <Page>
        <div className="success-message-container">
          <FormattedMessage id="creations.new.registration.creation_completed_first_message" />
          <FormattedMessage id="creations.new.registration.creation_completed_second_message" />
          <a
...
export default withUser(withNewCreation(withRouter(injectIntl(Completed))));
